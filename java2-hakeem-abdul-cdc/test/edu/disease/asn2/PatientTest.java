...
class PatientTest {
    ...
    @Test
    void testCompareToSameFirstNameDifferentLastName() {
    ...
    @Test
    void testCompareToSameFirstNameAndLastName() {
        Patient patient1 = new Patient(3, 2);
        patient1.setFirstName("John");
        patient1.setLastName("Doe");
        ...
        assertEquals(0, patient2.compareTo(patient1));
    }

    @Test
    void testCompareToNullLastName() {
        Patient patient1 = new Patient(3, 2);
        patient1.setFirstName("John");
        ...
        int result2 = patient2.compareTo(patient1);

        System.out.println("Result of patient1.compareTo(patient2): " + result1);
        System.out.println("Result of patient2.compareTo(patient1): " + result2);
